                ...
                foreach ($listColorPage as $key => $x) { ?>
                    <tr>
                        ...
                        <td style="width: 10%;" class="rounded-end-3">
                            ...
                            <a href="/admin/?view=Colors&edit=<?= $x['id'] ?>" class="btn"><i class="fa-solid fa-pen-to-square" style="color: #FFD43B;"></i></a>
                            <form action="./controllers/color/delete.php" method="post">
